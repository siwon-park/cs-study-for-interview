...
#### (1) 피터슨 알고리즘 (Peterson Algorithm)

프로세스가 2개일 경우에만 적용이 가능한 알고리즘. 따라서 현대의 컴퓨터에는 적용하기 어렵다는 단점이 있다.

lock 변수 외에 turn이라는 변수 하나를 더 추가해서 사용한다.

![image-20240428173239646](C:\Users\SIWON\AppData\Roaming\Typora\typora-user-images\image-20240428173239646.png)
